...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    ...
    "good night": "Sweet Dream babu… তবে আগে SOBHAN বস কে GN বলে নিও 😏💤",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "SOBHAN": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ SOBHAN KING ☜\nFacebook.https://www.facebook.com/share/1XYztfU6Qu/",
    "admin": "He is SOBHAN তাকে সবাই Admin SOBHAN হিসেবে চিনে😘☺️",
    ...
    "ami SOBHAN": "হ্যা বস কেমন আছেন..?☺️",
    "bot er baccha": "আমার বাচ্চা তো তোমার গার্লফ্রেন্ডের পেটে..!!🌚⛏️",
    "tor nam ki": "MY NAME IS ─꯭─⃝‌‌ABDUS SOBHAN💖",
    ...
    "tui ke": "আমি তোর বস SOBHAN এর ChatBot 😏",
